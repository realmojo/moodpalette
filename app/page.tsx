  ...
  return (
    <>
      ...
      <article className="sr-only" aria-hidden="true">
        <h1>무드팔레트 (Mood Palette) - 무료 이미지 컬러 팔레트 추출기</h1>
        <p>
          무드팔레트(Mood Palette)는 이미지에서 주요 색상을 AI로 자동 추출하는
          무료 온라인 컬러 팔레트 도구입니다. 사진을 업로드하면 K-means
          클러스터링 알고리즘을 통해 최대 20가지 고유한 색상을 HEX 및 RGB
          값과 함께 즉시 확인할 수 있습니다. 회원가입 없이 무료로 사용 가능하며,
          모든 처리는 브라우저에서 이루어져 개인정보가 보호됩니다.
        </p>

        <h2>무드팔레트로 이미지에서 색상 추출하는 방법</h2>
        <ol>
          <li>무드팔레트 사이트에서 버튼을 클릭하거나 이미지를 캔버스에 드래그 앤 드롭하여 업로드합니다.</li>
        ...
        <ul>
          ...
          <li>AI 기반 K-means 클러스터링 색상 분석 알고리즘</li>
          <li>이미지 위에 배치된 인터랙티브 드래그 컬러 피커</li>
          <li>드래그 시 실시간 색상 업데이트</li>
          <li>HEX 및 RGB 색상 값 제공</li>
          <li>JPG, PNG, WebP, GIF, BMP, SVG 이미지 형식 지원</li>
          <li>드래그 앤 드롭 또는 클릭으로 간편 업로드</li>
          <li>100% 무료, 회원가입 불필요</li>
          <li>브라우저에서 처리하여 이미지 개인정보 완전 보호</li>
          <li>데스크탑 및 모바일 기기 모두 지원</li>
        </ul>

        <h2>무드팔레트 활용 사례</h2>
        <p>
          무드팔레트는 그래픽 디자이너, 웹 개발자, UI/UX 디자이너, 아티스트,
          인테리어 디자이너 등 이미지에서 컬러 팔레트를 추출해야 하는 모든
          크리에이터에게 적합합니다. 브랜드 아이덴티티 제작, 웹사이트 디자인,
          SNS 콘텐츠 컬러 기획, 또는 다음 작품을 위한 영감을 찾을 때
          무드팔레트가 도움을 드립니다.
        </p>

        <h2>Mood Palette - Free Image Color Palette Extractor</h2>
        <p>
